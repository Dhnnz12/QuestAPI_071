...
import com.example.questapi_071.modeldata.toDataSiswa
import com.example.questapi_071.modeldata.toUiStateSiswa
import com.example.questapi_071.repositori.RepositoryDataSiswa
...
class EditViewModel(
    ...
    suspend fun editSatuSiswa() {
        if (validasiInput(uiStateSiswa.detailSiswa)) {
            val call: retrofit2.Response<Void> = repositoryDataSiswa.editSatuSiswa(idSiswa, uiStateSiswa.detailSiswa.toDataSiswa())
